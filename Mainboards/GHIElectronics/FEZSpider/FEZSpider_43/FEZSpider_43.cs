...
namespace GHIElectronics.Gadgeteer {
    ...
    public class FEZSpider : GT.Mainboard {
        ...
        public FEZSpider() {
            if ((DeviceType)SystemInfo.SystemID.Model != DeviceType.EMX) throw new InvalidOperationException("You have selected the wrong mainboard in the designer. Please double check your mainboard.");
