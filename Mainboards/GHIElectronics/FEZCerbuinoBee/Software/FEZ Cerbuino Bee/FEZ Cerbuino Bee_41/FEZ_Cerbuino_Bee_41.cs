...
namespace GHIElectronics.Gadgeteer
{
    ...
    public class FEZCerbuinoBee : GT.Mainboard
    {
        ...
        {
            throw new Exception("FEZCerbuino is not supported in 4.1");
            ...
            socket.NativeI2CWriteRead = nativeI2C;
            socket.AnalogInput3 = new FEZCerbuinoBee_AIN((Cpu.Pin)12);
            socket.AnalogInput4 = new FEZCerbuinoBee_AIN((Cpu.Pin)13);
            socket.AnalogInput5 = new FEZCerbuinoBee_AIN((Cpu.Pin)14);
            socket.AnalogOutput = new FEZCerbuinoBee_AnalogOut((Cpu.Pin)14);
            socket.PWM7 = new FEZCerbuinoBee_PWM((Cpu.Pin)17);
            socket.PWM8 = new FEZCerbuinoBee_PWM((Cpu.Pin)18);
            socket.PWM9 = new FEZCerbuinoBee_PWM((Cpu.Pin)19);
            GT.Socket.SocketInterfaces.RegisterSocket(socket);
    ...
    internal class FEZCerbuinoBee_PWM : GT.Socket.SocketInterfaces.PWM
    {
        ...
        public FEZCerbuinoBee_PWM(Cpu.Pin pin)
        {
            this.pin = pin;
        }
    ...
    internal class FEZCerbuinoBee_AnalogOut : GT.Socket.SocketInterfaces.AnalogOutput
    {
        ...
        public FEZCerbuinoBee_AnalogOut(Cpu.Pin pin)
        {
            this.pin = pin;
        }
    ...
    internal class FEZCerbuinoBee_AIN : GT.Socket.SocketInterfaces.AnalogInput
    {
        ...
        public FEZCerbuinoBee_AIN(Cpu.Pin pin)
        {
            this.pin = pin;
        }
