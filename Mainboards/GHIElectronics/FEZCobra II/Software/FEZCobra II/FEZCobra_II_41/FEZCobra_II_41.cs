...
namespace GHIElectronics.Gadgeteer
{
    ...
    public class FEZCobra_II : GT.Mainboard
    {
        ...
        /// <summary>
        /// Instantiates a new FEZCobra II mainboard
        /// </summary>
        public FEZCobra_II()
        {
            ...
            socket.NativeI2CWriteRead = nativeI2C;
            socket.AnalogInput3 = new FEZCobra_II_AIN((Cpu.Pin)12);
            socket.AnalogInput4 = new FEZCobra_II_AIN((Cpu.Pin)13);
            socket.AnalogInput5 = new FEZCobra_II_AIN((Cpu.Pin)14);
            socket.AnalogOutput = new FEZCobra_II_AnalogOut((Cpu.Pin)14);
            socket.PWM7 = new FEZCobra_II_PWM((Cpu.Pin)17);
            socket.PWM8 = new FEZCobra_II_PWM((Cpu.Pin)18);
            socket.PWM9 = new FEZCobra_II_PWM((Cpu.Pin)19);
            GT.Socket.SocketInterfaces.RegisterSocket(socket);
    ...
    internal class FEZCobra_II_PWM : GT.Socket.SocketInterfaces.PWM
    {
        ...
        public FEZCobra_II_PWM(Cpu.Pin pin)
        {
            this.pin = pin;
        }
    ...
    internal class FEZCobra_II_AIN : GT.Socket.SocketInterfaces.AnalogInput
    {
        ...
        public FEZCobra_II_AIN(Cpu.Pin pin)
        {
            this.pin = pin;
        }
