...
namespace GHIElectronics.Gadgeteer {
	...
	public class FEZCobraIINet : GT.Mainboard {
		...
		public delegate void SDCardMountedEventHandler(FEZCobraIINet sender, GT.StorageDevice device);

		/// <summary>Represents the delegate that is used for the Unmounted event.</summary>
		/// <param name="sender">The object that raised the event.</param>
		/// <param name="e">The event arguments.</param>
		public delegate void SDCardUnmountedEventHandler(FEZCobraIINet sender, EventArgs e);
		...
		private void OnSDCardMounted(FEZCobraIINet sender, GT.StorageDevice device) {
		...
		private void OnSDCardUnmounted(FEZCobraIINet sender, EventArgs e) {
		...
		/// <param name="sender">The object that raised the event.</param>
		/// <param name="device">A storage device that can be used to access the SD card.</param>
		public delegate void MassStorageMountedEventHandler(FEZCobraIINet sender, GT.StorageDevice device);

		/// <summary>Represents the delegate that is used for the MassStorageUnmounted event.</summary>
		/// <param name="sender">The object that raised the event.</param>
		/// <param name="e">The event arguments.</param>
		public delegate void MassStorageUnmountedEventHandler(FEZCobraIINet sender, EventArgs e);
		...
		public delegate void MouseConnectedEventHandler(FEZCobraIINet sender, Mouse mouse);
		...
		public delegate void KeyboardConnectedEventHandler(FEZCobraIINet sender, Keyboard keyboard);
		...
		private void OnMassStorageMounted(FEZCobraIINet sender, GT.StorageDevice device) {
		...
		private void OnMassStorageUnmounted(FEZCobraIINet sender, EventArgs e) {
		...
		private void OnMouseConnected(FEZCobraIINet sender, Mouse mouse) {
		...
		private void OnKeyboardConnected(FEZCobraIINet sender, Keyboard keyboard) {
