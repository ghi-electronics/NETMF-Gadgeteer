...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class Video_Out : GTM.Module.DisplayModule
    {
            ...
            : base(WpfMode.PassThrough)
        {
            ...
            //i2cBus2 = GTI.I2CBusFactory.Create(i2cSocket, DEVICE_ADDR, 100, this);
            softwareI2C = new GTI.SoftwareI2CBus(i2cSocket, Socket.Pin.Five, Socket.Pin.Four, DEVICE_ADDR, 100, this);
        }

        private const byte DEVICE_ADDR = 0X76;

        private static int m_currWidth = 320;
        private static int m_currHeight = 240;
        ...
        public void SetDisplayConfiguration(Video_Out_InputResolution res)
        {
            ...
            lcdConfig.CommonSyncPinIsActiveHigh = false; //not the proper property, but we needed it for OutputEnablePolarity
            ...
            lcdConfig.MaximumClockSpeed = 10000;

            // Set config
            base.OnDisplayConnected("Video Out", m_currWidth, m_currHeight, DisplayOrientation.Normal, lcdConfig);
        ...
        private static void I2CWrite(byte address, byte data)
        {
            ...
            softwareI2C.Write(Write_buffer);
            //i2cBus2.Write(write_buffer);
        }
        ...
        private static byte I2CRead(byte address)
        {
            ...
            //i2cBus2.Read(read_buffer);
            softwareI2C.WriteRead(Write_buffer, Read_buffer);
