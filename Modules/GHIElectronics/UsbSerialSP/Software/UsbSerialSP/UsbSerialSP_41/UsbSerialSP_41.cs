...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class UsbSerialSP : GTM.Module
    {
        ...
        // GTM.GHIElectronics.UsbSerialSP. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the UsbSerialSP module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public UsbSerialSP(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the UsbSerialSP is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="UsbSerialSP"/>.
        /// </summary>
        ...
        /// <param name="state">The state of the button of the <see cref="UsbSerialSP"/></param>
        public delegate void ButtonEventHandler(UsbSerialSP sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="UsbSerialSP"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="UsbSerialSP"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="UsbSerialSP"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(UsbSerialSP sender, ButtonState buttonState)
        {
