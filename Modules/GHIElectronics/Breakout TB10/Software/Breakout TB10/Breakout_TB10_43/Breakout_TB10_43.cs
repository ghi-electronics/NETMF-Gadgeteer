...
{
	/// <summary>
	/// A Breakout TB10 module for Microsoft .NET Gadgeteer
	/// </summary>
	public class Breakout_TB10 : GTM.Module
	{
		...
		public Breakout_TB10(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the Breakout_TB10 is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="Breakout_TB10"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="Breakout_TB10"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="Breakout_TB10"/></param>
		public delegate void ButtonEventHandler(Breakout_TB10 sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="Breakout_TB10"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="Breakout_TB10"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="Breakout_TB10"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(Breakout_TB10 sender, ButtonState buttonState)
		{
