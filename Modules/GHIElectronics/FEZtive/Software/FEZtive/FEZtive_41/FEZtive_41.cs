...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class FEZtive : GTM.Module
    {
        ...
        // GTM.GHIElectronics.FEZtive. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the FEZtive module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public FEZtive(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the FEZtive is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="FEZtive"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="FEZtive"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="FEZtive"/></param>
        public delegate void ButtonEventHandler(FEZtive sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="FEZtive"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="FEZtive"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="FEZtive"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(FEZtive sender, ButtonState buttonState)
        {
