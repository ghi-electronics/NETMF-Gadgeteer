...
{
    /// <summary>
    /// A Video_Out module for Microsoft .NET Gadgeteer
    /// </summary>
    /// <example>
    ...
    public class Video_Out : GTM.Module.DisplayModule
    {
        ...
        /// 
        /// </summary>
        public static GT.Interfaces.SoftwareI2C softwareI2C;
#else
        private static SoftwareI2CBus i2cBus;
        private static SoftwareI2CBus.I2CDevice myDevice;
#endif
...
#else
            i2cBus = new SoftwareI2CBus(i2cSocket.CpuPins[4], i2cSocket.CpuPins[5]);
            myDevice = i2cBus.CreateI2CDevice(DEVICE_ADDR, 100);
#endif
        }
...
#else
            myDevice.Write(Write_buffer, 0, Write_buffer.Length);
#endif
        }
        ...
        private static byte I2CRead(byte address)
        {
            ...
            int read;
            int written;
            myDevice.WriteRead(Write_buffer, 0, 1, Read_buffer, 0, 1, out written, out read);
