...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class LED_Strip : GTM.Module
    {
        ...
        // GTM.GHIElectronics.LED_Strip. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the LED Strip module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public LED_Strip(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the LED_Strip is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="LED_Strip"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="LED_Strip"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="LED_Strip"/></param>
        public delegate void ButtonEventHandler(LED_Strip sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="LED_Strip"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="LED_Strip"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="LED_Strip"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(LED_Strip sender, ButtonState buttonState)
        {
