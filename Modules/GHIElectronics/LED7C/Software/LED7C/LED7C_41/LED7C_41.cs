...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class LED7C : GTM.Module
    {
        ...
        // GTM.GHIElectronics.LED7C. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the LED7C module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public LED7C(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the LED7C is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="LED7C"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="LED7C"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="LED7C"/></param>
        public delegate void ButtonEventHandler(LED7C sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="LED7C"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="LED7C"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="LED7C"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(LED7C sender, ButtonState buttonState)
        {
