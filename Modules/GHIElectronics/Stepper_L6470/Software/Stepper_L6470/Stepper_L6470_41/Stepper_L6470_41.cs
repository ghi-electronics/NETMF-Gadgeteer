...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class Stepper_L6470 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Stepper_L6470. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Stepper_L6470 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Stepper_L6470(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Stepper_L6470 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Stepper_L6470"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Stepper_L6470"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Stepper_L6470"/></param>
        public delegate void ButtonEventHandler(Stepper_L6470 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Stepper_L6470"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Stepper_L6470"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Stepper_L6470"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Stepper_L6470 sender, ButtonState buttonState)
        {
