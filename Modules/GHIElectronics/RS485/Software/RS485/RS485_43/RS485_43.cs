...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class RS485 : GTM.Module
	{
		...
		public RS485(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the RS485 is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="RS485"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="RS485"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="RS485"/></param>
		public delegate void ButtonEventHandler(RS485 sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="RS485"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="RS485"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="RS485"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(RS485 sender, ButtonState buttonState)
		{
