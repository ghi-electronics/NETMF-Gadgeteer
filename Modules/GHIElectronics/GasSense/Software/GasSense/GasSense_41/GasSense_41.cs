...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class GasSense : GTM.Module
    {
        ...
        // GTM.GHIElectronics.GasSense. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the GasSense module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public GasSense(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the GasSense is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="GasSense"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="GasSense"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="GasSense"/></param>
        public delegate void ButtonEventHandler(GasSense sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="GasSense"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="GasSense"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="GasSense"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(GasSense sender, ButtonState buttonState)
        {
