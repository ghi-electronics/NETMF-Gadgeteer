...
{
    /// <summary>
    /// A Display TE35 module for Microsoft .NET Gadgeteer
    /// </summary>
    public class Display_TE35 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Display_TE35. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Display TE35 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Display_TE35(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Display_TE35 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Display_TE35"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Display_TE35"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Display_TE35"/></param>
        public delegate void ButtonEventHandler(Display_TE35 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Display_TE35"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Display_TE35"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Display_TE35"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Display_TE35 sender, ButtonState buttonState)
        {
