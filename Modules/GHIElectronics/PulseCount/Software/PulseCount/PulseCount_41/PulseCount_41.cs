...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class PulseCount : GTM.Module
    {
        ...
        // GTM.GHIElectronics.PulseCount. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the PulseCount module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public PulseCount(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the PulseCount is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="PulseCount"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="PulseCount"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="PulseCount"/></param>
        public delegate void ButtonEventHandler(PulseCount sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="PulseCount"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="PulseCount"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="PulseCount"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(PulseCount sender, ButtonState buttonState)
        {
