...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    {
        private ArrayList persistentStorageDevices;

        // NOTE: This only supports one USB storage device at one time.
        private static PersistentStorage _storageDevice;
        private static USBH_Mouse _mouse;
        private static USBH_Keyboard _keyboard;
        ...
        public UsbHost(int socketNumber)
        {
            ...
            persistentStorageDevices = new ArrayList();
            try
            {
        ...
        private void USBHostController_DeviceDisconnectedEvent(USBH_Device device)
        {
            switch (device.TYPE)
            {
                case USBH_DeviceType.MassStorage:
                    ...
                    {
                        _storageDevice.UnmountFileSystem();
                        _storageDevice.Dispose();
                    }
                    break;
                case USBH_DeviceType.Mouse:
                    if (_mouse != null)
                    {
                        OnMouseDisconnectedEvent(this, _mouse);
                        _mouse = null;
                    }
                    break;
                case USBH_DeviceType.Keyboard:
                    if (_keyboard != null)
                    {
                        OnKeyboardDisconnectedEvent(this, _keyboard);
                        _keyboard = null;
                    }
                    break;
                default:
