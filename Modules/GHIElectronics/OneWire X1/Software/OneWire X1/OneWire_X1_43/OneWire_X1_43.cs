...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class OneWire_X1 : GTM.Module
	{
		...
		public OneWire_X1(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the OneWire_X1 is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="OneWire_X1"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="OneWire_X1"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="OneWire_X1"/></param>
		public delegate void ButtonEventHandler(OneWire_X1 sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="OneWire_X1"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="OneWire_X1"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="OneWire_X1"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(OneWire_X1 sender, ButtonState buttonState)
		{
