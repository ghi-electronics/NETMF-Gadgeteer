...
namespace Gadgeteer.Modules.GHIElectronics {
    /// <summary>A Camera module for Microsoft .NET Gadgeteer</summary>
    [Obsolete]
    public class Camera : GTM.Module {
        ...
        /// <summary>Represents the delegate that is used for the <see cref="PictureCaptured" /> event.</summary>
        ...
        /// <summary>Represents the delegate that is used to handle the <see cref="BitmapStreamed" /> event.</summary>
        /// <param name="sender">The <see cref="Camera" /> object that raised the event.</param>
        ...
        /// <summary>Represents the delegate to handle the <see cref="CameraConnected" />.</summary>
        /// <param name="sender">The object that raised the event.</param>
        /// <param name="e">The event arguments.</param>
        public delegate void CameraEventHandler(Camera sender, EventArgs e);

        /// <summary>Raised when the camera has completed streaming a bitmap.</summary>
        public event BitmapStreamedEventHandler BitmapStreamed;

        /// <summary>Raised when the camera has captured an picture.</summary>
        public event PictureCapturedEventHandler PictureCaptured;

        /// <summary>Raised when the camera is connected.</summary>
        public event CameraEventHandler CameraConnected;

        /// <summary>Raised when the camera is disconnected.</summary>
        public event CameraEventHandler CameraDisconnected;

        /// <summary>Whether or not the camera is ready to take pictures.</summary>
        public bool CameraReady { get { return this.status == CameraStatus.Ready; } }

        /// <summary>The resolution of the pictures to capture.</summary>
        public PictureResolution CurrentPictureResolution { get; set; }

        /// <summary>This property is for calibration purposes. Do not change the value if not advised to.</summary>
        public TimeSpan RestartStreamingTrigger { get; set; }

        /// <summary>How long to continue streaming for after TakePicture is called.</summary>
        ...
        /// <summary>Starts streaming pictures.</summary>
