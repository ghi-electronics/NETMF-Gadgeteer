...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    /// <remarks>
    /// <para>
    /// The <see cref="UC_Battery_4xAA"/> class has no programmable functionality other than internally reserving 
    ...
    /// </list>
    /// </remarks>
    public class UC_Battery_4xAA : GTM.Module
    {
        ...
        public UC_Battery_4xAA(int socketNumber)
        {
