...
{
    /// <summary>
    /// A UC Battery 4xAA module for Microsoft .NET Gadgeteer
    /// </summary>
    public class UC_Battery_4xAA : GTM.Module
    {
        ...
        // GTM.GHIElectronics.UC_Battery_4xAA. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the UC Battery 4xAA module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public UC_Battery_4xAA(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the UC_Battery_4xAA is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="UC_Battery_4xAA"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="UC_Battery_4xAA"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="UC_Battery_4xAA"/></param>
        public delegate void ButtonEventHandler(UC_Battery_4xAA sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="UC_Battery_4xAA"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="UC_Battery_4xAA"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="UC_Battery_4xAA"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(UC_Battery_4xAA sender, ButtonState buttonState)
        {
