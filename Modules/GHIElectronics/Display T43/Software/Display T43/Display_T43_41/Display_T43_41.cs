...
{
    /// <summary>
    /// A Display T43 module for Microsoft .NET Gadgeteer
    /// </summary>
    public class Display_T43 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Display_T43. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Display T43 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Display_T43(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Display_T43 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Display_T43"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Display_T43"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Display_T43"/></param>
        public delegate void ButtonEventHandler(Display_T43 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Display_T43"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Display_T43"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Display_T43"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Display_T43 sender, ButtonState buttonState)
        {
