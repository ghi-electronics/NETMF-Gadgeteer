...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class Tunes : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Tunes. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Tunes module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Tunes(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Tunes is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Tunes"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Tunes"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Tunes"/></param>
        public delegate void ButtonEventHandler(Tunes sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Tunes"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Tunes"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Tunes"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Tunes sender, ButtonState buttonState)
        {
