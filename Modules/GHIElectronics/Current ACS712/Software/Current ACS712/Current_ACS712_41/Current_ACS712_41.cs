...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class Current_ACS712 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Current_ACS712. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Current ACS712 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Current_ACS712(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Current_ACS712 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Current_ACS712"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Current_ACS712"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Current_ACS712"/></param>
        public delegate void ButtonEventHandler(Current_ACS712 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Current_ACS712"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Current_ACS712"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Current_ACS712"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Current_ACS712 sender, ButtonState buttonState)
        {
