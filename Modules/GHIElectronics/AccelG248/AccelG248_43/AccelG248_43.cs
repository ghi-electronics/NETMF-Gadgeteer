...
namespace Gadgeteer.Modules.GHIElectronics {
	...
	public class AccelG248 : GTM.Module {
		...
		public struct Acceleration {
			...
			/// <summary>The x acceleration between -1 and 1.</summary>
			public double X { get; set; }

			/// <summary>The y acceleration between -1 and 1.</summary>
			public double Y { get; set; }

			/// <summary>The z acceleration between -1 and 1.</summary>
