...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class RS232 : GTM.Module
    {
        ...
        /// <summary>
        /// Initializes the serial port with the parameters 9600 baud, 8N1, with no flow control.
        /// </summary>
        ...
        {
            if (this.serialPort != null && this.serialPort.IsOpen) throw new InvalidOperationException("Configure can only be when the port is closed.");
