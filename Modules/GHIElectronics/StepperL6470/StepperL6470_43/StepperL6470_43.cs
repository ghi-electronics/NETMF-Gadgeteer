...
namespace Gadgeteer.Modules.GHIElectronics {
	/// <summary>A StepperL6470 module for Microsoft .NET Gadgeteer</summary>
	[Obsolete]
	public class StepperL6470 : GTM.Module {
		...
		public enum Action : byte {
			...
			/// <summary>The reset option.</summary>
			Reset = 0x00,

			/// <summary>The copy option.</summary>
			Copy = 0x01
		};

		/// <summary>Direction Options</summary>
		public enum Direction : byte {

			/// <summary>The forward option.</summary>
			Forward = 0x01,

			/// <summary>The reverse option.</summary>
			Reverse = 0x00
		};

		/// <summary>Status Masks</summary>
		public enum StatusMask : ushort {

			/// <summary>The HIZ status mask.</summary>
			Hiz = 0x0001,

			/// <summary>The BUSY status mask.</summary>
			Busy = 0x0002,

			/// <summary>The SW_F status mask.</summary>
			SwF = 0x0004,

			/// <summary>The SW_EVN status mask.</summary>
			SwEvn = 0x0008,

			/// <summary>The DIR status mask.</summary>
			Dir = 0x0010,

			/// <summary>The MOT_STATUS status mask.</summary>
			MotStatus = 0x0060,

			/// <summary>The NOTPERF_CMD status mask.</summary>
			NotPerfCmd = 0x0080,

			/// <summary>The WRONG_CMD status mask.</summary>
			WrongCmd = 0x0100,

			/// <summary>The OVLO status mask.</summary>
			Uvlo = 0x0200,

			/// <summary>The TH_WRN status mask.</summary>
			ThWrn = 0x0400,

			/// <summary>The TH_SD status mask.</summary>
			ThSd = 0x0800,

			/// <summary>The OCD status mask.</summary>
			Ocd = 0x1000,

			/// <summary>The STEP_LOSS_a status mask.</summary>
			StepLossA = 0x2000,

			/// <summary>The STATUS_STEP_LOSS_B status mask.</summary>
			StepLossB = 0x4000,

			/// <summary>The STATUS_SCK_MOD status mask.</summary>
			SckMod = 0x8000
		}
		...
		public enum RegisterAddress : byte {
			...
			/// <summary>The ABS_POS register.</summary>
			AbsPos = 0x01,

			/// <summary>The EL_POS register.</summary>
			ElPos = 0x02,

			/// <summary>The MARK register.</summary>
			Mark = 0x03,

			/// <summary>The SPEED register.</summary>
			Speed = 0x04,

			/// <summary>The ACC register.</summary>
			Acc = 0x05,

			/// <summary>The DEC register.</summary>
			Dec = 0x06,

			/// <summary>The MAX_SPEED register.</summary>
			MaxSpeed = 0x07,

			/// <summary>The MIN_SPEED register.</summary>
			MinSpeed = 0x08,

			/// <summary>The FS_SPD register.</summary>
			FsSpd = 0x15,

			/// <summary>The KVAL_HOLD register.</summary>
			KValHold = 0x09,

			/// <summary>The KVAL_RUN register.</summary>
			KValRun = 0x0A,

			/// <summary>The KVAL_ACC register.</summary>
			KValAcc = 0x0B,

			/// <summary>The KVAL_DEC register.</summary>
			KValDev = 0x0C,

			/// <summary>The INT_SPD register.</summary>
			IntSpd = 0x0D,

			/// <summary>The ST_SLP register.</summary>
			StSlp = 0x0E,

			/// <summary>The FN_SLP_ACC register.</summary>
			FnSlpAcc = 0x0F,

			/// <summary>The FN_SLP_DEC register.</summary>
			FnSlpDec = 0x10,

			/// <summary>The K_THERM register.</summary>
			KTherm = 0x11,

			/// <summary>The ADC_OUT register.</summary>
			AdcOut = 0x12,

			/// <summary>The OCD_TH register.</summary>
			OcdTh = 0x13,

			/// <summary>The STALL_TH register.</summary>
			StallTh = 0x14,

			/// <summary>The STEP_MODE register.</summary>
			StepMode = 0x16,

			/// <summary>The ALARM_EN register.</summary>
			AlarmEn = 0x17,

			/// <summary>The CONFIG register.</summary>
			Config = 0x18,

			/// <summary>The STATUS register.</summary>
			Status = 0x19,

			/// <summary>The RESERVED_REG1 register.</summary>
			ReservedReg1 = 0x1A,

			/// <summary>The RESERVED_REG2 register.</summary>
			ReservedReg2 = 0x1B
		}
		...
		public enum Command : byte {
			...
			/// <summary>The NOP command.</summary>
			Nop = 0x00,

			/// <summary>The SET_PARAM command.</summary>
			SetParam = 0x00,

			/// <summary>The GET_PARAM command.</summary>
			GetParam = 0x20,

			/// <summary>The RUN command.</summary>
			Run = 0x50,

			/// <summary>The STEP_CLOCK command.</summary>
			StepClock = 0x58,

			/// <summary>The MOVE command.</summary>
			Move = 0x40,

			/// <summary>The GO_TO command.</summary>
			GoTo = 0x60,

			/// <summary>The GO_TO_DIR command.</summary>
			GoToDir = 0x68,

			/// <summary>The GO_UNTIL command.</summary>
			GoUntil = 0x82,

			/// <summary>The RELEASE_SW command.</summary>
			ReleaseSw = 0x92,

			/// <summary>The GO_HOME command.</summary>
			GoHome = 0x70,

			/// <summary>The GO_MARK command.</summary>
			GoMark = 0x78,

			/// <summary>The RESET_POS command.</summary>
			ResetPos = 0xD8,

			/// <summary>The RESET_DEVICE command.</summary>
			ResetDevice = 0xC0,

			/// <summary>The SOFT_STOP command.</summary>
			SoftStop = 0xB0,

			/// <summary>The HARD_STOP command.</summary>
			HardStop = 0xB8,

			/// <summary>The SOFT_HIZ command.</summary>
			SoftHiz = 0xA0,

			/// <summary>The HARD_HIZ command.</summary>
			HardHiz = 0xA8,

			/// <summary>The GET_STATUS command.</summary>
			GetStatus = 0xD0,

			/// <summary>The RESERVED_CMD1 command.</summary>
			ReservedCmd1 = 0xEB,

			/// <summary>The RESERVED_CMD2 command.</summary>
			ReservedCmd2 = 0xF8
		}

		/// <summary>Overcurrent Detection Threshold Options</summary>
		public enum OvercurrentDetectionThreshold : byte {

			/// <summary>The 375mA option.</summary>
			Thershold375mA = 0x00,

			/// <summary>The 750mA option.</summary>
			Thershold750mA = 0x01,

			/// <summary>The 1125mA option.</summary>
			Thershold1125mA = 0x02,

			/// <summary>The 1500mA option.</summary>
			Thershold1500mA = 0x03,

			/// <summary>The 1875mA option.</summary>
			Thershold1875mA = 0x04,

			/// <summary>The 2250mA option.</summary>
			Thershold2250mA = 0x05,

			/// <summary>The 2625mA option.</summary>
			Thershold2625mA = 0x06,

			/// <summary>The 3000mA option.</summary>
			Thershold3000mA = 0x07,

			/// <summary>The 3375mA option.</summary>
			Thershold3375mA = 0x08,

			/// <summary>The 3750mA option.</summary>
			Thershold3750mA = 0x09,

			/// <summary>The 4125mA option.</summary>
			Thershold4125mA = 0x0A,

			/// <summary>The 4500mA option.</summary>
			Thershold4500mA = 0x0B,

			/// <summary>The 4875mA option.</summary>
			Thershold4875mA = 0x0C,

			/// <summary>The 5250mA option.</summary>
			Thershold5250mA = 0x0D,

			/// <summary>The 5625mA option.</summary>
			Thershold5625mA = 0x0E,

			/// <summary>The 6000mA option.</summary>
			Thershold6000mA = 0x0F
		}

		/// <summary>Step Select Options</summary>
		public enum StepSelect : byte {

			/// <summary>The step 1 option.</summary>
			Select_1 = 0x00,

			/// <summary>The step 2 option.</summary>
			Select_1_2 = 0x01,

			/// <summary>The step 4 option.</summary>
			Select_1_4 = 0x02,

			/// <summary>The step 8 option.</summary>
			Select_1_8 = 0x03,

			/// <summary>The step 16 option.</summary>
			Select_1_16 = 0x04,

			/// <summary>The step 32 option.</summary>
			Select_1_32 = 0x05,

			/// <summary>The step 64 option.</summary>
			Select_1_64 = 0x06,

			/// <summary>The step 128 option.</summary>
			Select_1_128 = 0x07
		}

		/// <summary>Alarm Enable Options</summary>
		public enum AlarmEnable : byte {

			/// <summary>The overcurrent option.</summary>
			Overcurrent = 0x01,

			/// <summary>The thermal shutdown option.</summary>
			ThermalShutdown = 0x02,

			/// <summary>The thermal warning option.</summary>
			ThermalWarning = 0x04,

			/// <summary>The under voltage option.</summary>
			UnderVoltage = 0x08,

			/// <summary>The stall detection A option.</summary>
			StallDetectA = 0x10,

			/// <summary>The stall detection B option.</summary>
			StallDetectB = 0x20,

			/// <summary>The turn on sw option.</summary>
			SwTurnOn = 0x40,

			/// <summary>The wrong nperf option.</summary>
			WrongNperf = 0x80
		}

		/// <summary>Configuration Register Options</summary>
		public enum ConfigOscManagement : ushort {

			/// <summary>The 16MHz option.</summary>
			Int16MHz = 0x0000,

			/// <summary>The 16MHz OSCOUNT 2MHz option.</summary>
			Int16MHzOscout2MHz = 0x0008,

			/// <summary>The 16MHz OSCOUNT 4MHz option.</summary>
			Int16MHzOscout4MHz = 0x0009,

			/// <summary>The 16MHz OSCOUNT 8MHz option.</summary>
			Int16MHzOscout8MHz = 0x000A,

			/// <summary>The 16MHz OSCOUNT 16MHz option.</summary>
			Int16MHzOscout16MHz = 0x000B,

			/// <summary>The 8MHz XTAL drive option.</summary>
			Ext8MHzXtalDrive = 0x0004,

			/// <summary>The 16MHz XTAL drive option.</summary>
			Ext16MHzXtalDrive = 0x0005,

			/// <summary>The 24MHz XTAL drive option.</summary>
			Ext24MHzXtalDrive = 0x0006,

			/// <summary>The 32MHz XTAL drive option.</summary>
			Ext32MHzXtalDrive = 0x0007,

			/// <summary>The 8MHz OSCOUNT invert option.</summary>
			Ext8MHzOscoutInvert = 0x000C,

			/// <summary>The 16MHz OSCOUNT invert option.</summary>
			Ext16MHzOscoutInvert = 0x000D,

			/// <summary>The 24MHz OSCOUNT invert option.</summary>
			Ext24MHzOscoutInvert = 0x000E,

			/// <summary>The 32MHz OSCOUNT invert option.</summary>
			Ext32MHzOscoutInvert = 0x000F
		}

		/// <summary>The SW Mode configuration.</summary>
		public enum ConfigSwMode : ushort {

			/// <summary>The hard stop option.</summary>
			HardStop = 0x0000,

			/// <summary>The user option.</summary>
			User = 0x0010
		}

		/// <summary>The PWM configuration options.</summary>
		public enum ConfigFPwmDec : ushort {

			/// <summary>The 0-625 option.</summary>
			Mul_0_625 = 0x00 << 10,

			/// <summary>The 0-75 option.</summary>
			Mul_0_75 = 0x01 << 10,

			/// <summary>The 0-875 option.</summary>
			Mul_0_875 = 0x02 << 10,

			/// <summary>The 1 option.</summary>
			Mul_1 = 0x03 << 10,

			/// <summary>The 1-25 option.</summary>
			Mul_1_25 = 0x04 << 10,

			/// <summary>The 1-5 option.</summary>
			Mul_1_5 = 0x05 << 10,

			/// <summary>The 1-75 option.</summary>
			Mul_1_75 = 0x06 << 10,

			/// <summary>The 2 option.</summary>
			Mul_2 = 0x07 << 10
		}

		/// <summary>The PWM INT configuration options.</summary>
		public enum ConfigFPwmInt : ushort {

			/// <summary>The DIV 1 option.</summary>
			Div1 = 0x00 << 13,

			/// <summary>The DIV 2 option.</summary>
			Div2 = 0x01 << 13,

			/// <summary>The DIV 3 option.</summary>
			Div3 = 0x02 << 13,

			/// <summary>The DIV 4 option.</summary>
			Div4 = 0x03 << 13,

			/// <summary>The DIV 5 option.</summary>
			Div5 = 0x04 << 13,

			/// <summary>The DIV 6 option.</summary>
			Div6 = 0x05 << 13,

			/// <summary>The DIV 7 option.</summary>
			Div7 = 0x06 << 13
		}

		/// <summary>The POW SR configuration options.</summary>
		public enum ConfigPowSr : ushort {

			/// <summary>The 180V option.</summary>
			V180 = 0x0000,

			/// <summary>The 290V option.</summary>
			V290 = 0x0200,

			/// <summary>The 530V option.</summary>
			V530 = 0x0300
		}

		/// <summary>The EN VSCOMP configuration options.</summary>
		public enum ConfigEnVscomp : ushort {

			/// <summary>The disable option.</summary>
			Disable = 0x0000,

			/// <summary>The enable option.</summary>
			Enable = 0x0020
		}

		/// <summary>The OC configuration options.</summary>
		...
		/// <summary>Send NOP operation code to the module</summary>
		public void Nop() {
		...
		/// <summary>Runs the motor</summary>
		...
		/// <summary>Steps the motor while the stepClock pin is high</summary>
		/// <param name="direction">Direction of the motor</param>
		public void StepClock(Direction direction) {
			this.WriteByte((byte)((byte)(Command.StepClock) | (byte)direction));
		}

		/// <summary>Moves the motor in the passed in direction for the passed in steps</summary>
		...
		/// <summary>Sets the motor to a specific position</summary>
		...
		/// <summary>Moves to a specific position, going in the passed in direction</summary>
		...
		/// <summary>Moves the motor until a specific action happens</summary>
		...
		/// <summary>Moves the motor to the home position</summary>
		public void GoHome() {
			this.WriteByte((byte)Command.GoHome);
		}

		/// <summary>Goes the motor to the mark position</summary>
		public void GoMark() {
			this.WriteByte((byte)Command.GoMark);
		}

		/// <summary>Resets the motor to the position</summary>
		...
		/// <summary>Soft stop operation</summary>
		public void SoftStop() {
			this.WriteByte((byte)Command.SoftStop);
		}

		/// <summary>Hard stop operation</summary>
		...
		/// <summary>Returns if the hardware is busy</summary>
		/// <returns>If the hardware is busy</returns>
		public bool BusyHW() {
			return !this.busyPin.Read();
		}

		/// <summary>Returns if the software is busy</summary>
		/// <returns>If the hardware is busy</returns>
		public byte BusySW() {
			return (byte)((this.GetStatus() & (ushort)StatusMask.Busy) == 0 ? 0x01 : 0x00);
		}

		/// <summary>Sets the registers to the passed in register values</summary>
		...
		/// <summary>Converts speed steps to par.</summary>
		...
		/// <summary>Converts AccDec steps to par.</summary>
		/// <param name="steps">The steps.</param>
		/// <returns>Steps expressed as par.</returns>
		...
		/// <summary>Converts max speed steps to par.</summary>
		/// <param name="steps">The steps.</param>
		/// <returns>Steps expressed as par.</returns>
		...
		/// <summary>Converts min speed steps to par.</summary>
		/// <param name="steps">The steps.</param>
		/// <returns>Steps expressed as par.</returns>
		...
		/// <summary>Converts FS speed steps to par.</summary>
		/// <param name="steps">The steps.</param>
		/// <returns>Steps expressed as par.</returns>
		...
		/// <summary>Converts int speed steps to par.</summary>
		/// <param name="steps">The steps.</param>
		/// <returns>Steps expressed as par.</returns>
		...
		/// <summary>Converts Kval percent to par.</summary>
		...
		/// <summary>Converts BEMF slope percent to par.</summary>
		/// <param name="perc">The percent.</param>
		/// <returns>Percent expressed as par.</returns>
		...
		/// <summary>Converts KTherm to par.</summary>
		...
		/// <summary>Converts StallTH to par.</summary>
		...
		/// <summary>Avalilable Registers</summary>
