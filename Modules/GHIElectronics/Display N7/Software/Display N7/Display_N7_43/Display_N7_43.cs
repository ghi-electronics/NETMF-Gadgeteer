...
{
	/// <summary>
	/// A Display N7 module for Microsoft .NET Gadgeteer
	/// </summary>
	public class Display_N7 : GTM.Module
	{
		...
		// GTM.GHIElectronics.$HardwareName$. This file will provide IntelliSense and documentation for the
		...
		public Display_N7(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the Display_N7 is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="Display_N7"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="Display_N7"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="Display_N7"/></param>
		public delegate void ButtonEventHandler(Display_N7 sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="Display_N7"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="Display_N7"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="Display_N7"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(Display_N7 sender, ButtonState buttonState)
		{
