...
namespace Gadgeteer.Modules.GHIElectronics {
	/// <summary>A ButtonS7 module for Microsoft .NET Gadgeteer</summary>
	[Obsolete]
	public class ButtonS7 : GTM.Module {
		...
		/// <summary>Represents the delegate that is used to handle the <see cref="EnterPressed" /> and <see cref="EnterReleased" /> events.</summary>
		...
		/// <summary>Raised when the button of the <see cref="ButtonS7" /> is pressed.</summary>
		/// <remarks>
		/// Implement this event handler and/or the <see cref="EnterReleased" /> event handler when you want to provide an action associated with button events. Since the state of the button is passed
		/// to the <see cref="EnterEventHandler" /> delegate, so you can use the same event handler for both button states.
		/// </remarks>
		public event EnterEventHandler EnterPressed;

		/// <summary>Raised when the button of the <see cref="ButtonS7" /> is released.</summary>
		/// <remarks>
		/// Implement this event handler and/or the <see cref="EnterPressed" /> event handler when you want to provide an action associated with button events. Since the state of the button is passed
		/// to the <see cref="EnterEventHandler" /> delegate, you can use the same event handler for both button states.
		/// </remarks>
		public event EnterEventHandler EnterReleased;

		/// <summary>Gets a value that indicates whether the given button of the ButtonS7 is pressed.</summary>
		...
		/// <summary>The buttons on the module.</summary>
		public enum Button {
		...
		/// <summary>Represents the state of the enter button of the <see cref="ButtonS7" />.</summary>
