...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class ButtonS7 : GTM.Module
	{
		...
		// GTM.GHIElectronics.ButtonS7. This file will provide IntelliSense and documentation for the
		// interface and make it easier for developers to use the ButtonS7 module.        
		...
		public ButtonS7(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the ButtonS7 is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="ButtonS7"/>.
		/// </summary>
		...
		public delegate void ButtonEventHandler(ButtonS7 sender, ButtonState state);
		...
		protected virtual void OnButtonEvent(ButtonS7 sender, ButtonState buttonState)
		{
