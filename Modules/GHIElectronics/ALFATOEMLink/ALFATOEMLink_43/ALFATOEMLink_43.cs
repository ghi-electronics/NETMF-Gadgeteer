...
{
    /// <summary>
    /// A ALFATOEMLink module for Microsoft .NET Gadgeteer
    /// </summary>
    public class ALFATOEMLink : GTM.Module
    {
        ...
        // GTM.GHIElectronics.ALFATOEMLink. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the ALFATOEMLink module.        
        ...
        public ALFATOEMLink(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the ALFATOEMLink is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="ALFATOEMLink"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="ALFATOEMLink"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="ALFATOEMLink"/></param>
        public delegate void ButtonEventHandler(ALFATOEMLink sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="ALFATOEMLink"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="ALFATOEMLink"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="ALFATOEMLink"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(ALFATOEMLink sender, ButtonState buttonState)
        {
