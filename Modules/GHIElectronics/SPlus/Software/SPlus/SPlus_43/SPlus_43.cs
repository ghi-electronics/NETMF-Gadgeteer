...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class SPlus : GTM.Module
	{
		...
		// GTM.GHIElectronics.SPlus. This file will provide IntelliSense and documentation for the
		// interface and make it easier for developers to use the SPlus module.        
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the SPlus is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="SPlus"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="SPlus"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="SPlus"/></param>
		public delegate void ButtonEventHandler(SPlus sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="SPlus"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="SPlus"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="SPlus"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(SPlus sender, ButtonState buttonState)
		{
