...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class Reflector_R3 : GTM.Module
	{
		...
		public Reflector_R3(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the Reflector_R3 is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="Reflector_R3"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="Reflector_R3"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="Reflector_R3"/></param>
		public delegate void ButtonEventHandler(Reflector_R3 sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="Reflector_R3"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="Reflector_R3"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="Reflector_R3"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(Reflector_R3 sender, ButtonState buttonState)
		{
