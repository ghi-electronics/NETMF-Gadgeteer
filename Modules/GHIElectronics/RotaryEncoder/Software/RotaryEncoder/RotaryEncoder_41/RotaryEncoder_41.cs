...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class RotaryEncoder : GTM.Module
    {
        ...
        // GTM.GHIElectronics.RotaryEncoder. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the RotaryEncoder module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public RotaryEncoder(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the RotaryEncoder is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="RotaryEncoder"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="RotaryEncoder"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="RotaryEncoder"/></param>
        public delegate void ButtonEventHandler(RotaryEncoder sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="RotaryEncoder"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="RotaryEncoder"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="RotaryEncoder"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(RotaryEncoder sender, ButtonState buttonState)
        {
