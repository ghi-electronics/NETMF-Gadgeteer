...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class Button : GTM.Module
    {
        ...
        {
            ButtonState state = input.Read() ? ButtonState.Released : ButtonState.Pressed;
        ...
        /// <summary>
        /// Represents the delegate that is used to handle the <see cref="ButtonReleased"/> and <see cref="ButtonPressed"/> events.
        /// </summary>
