...
namespace Gadgeteer.Modules.GHIElectronics {
	/// <summary>An LEDMatrix module for .NET Gadgeteer</summary>
	[Obsolete]
	public class LEDMatrix : GTM.DaisyLinkModule {
		...
		public LEDMatrix(int socketNumber)
			: base(socketNumber, LEDMatrix.GHI_DAISYLINK_MANUFACTURER, LEDMatrix.GHI_DAISYLINK_TYPE_LEDMATRIX, LEDMatrix.GHI_DAISYLINK_VERSION_LEDMATRIX, LEDMatrix.GHI_DAISYLINK_VERSION_LEDMATRIX, 50, "LEDMatrix") {
		}

		/// <summary>Draws an 8x8 bitmap to the module.</summary>
