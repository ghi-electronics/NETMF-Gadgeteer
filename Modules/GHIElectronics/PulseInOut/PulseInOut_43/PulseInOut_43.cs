...
namespace Gadgeteer.Modules.GHIElectronics {
	/// <summary>A PulseInOut module for Microsoft .NET Gadgeteer</summary>
	[Obsolete]
	public class PulseInOut : DaisyLinkModule {
		...
		public PulseInOut(int socketNumber)
			: base(socketNumber, PulseInOut.GHI_DAISYLINK_MANUFACTURER, PulseInOut.GHI_DAISYLINK_TYPE_PULSE, PulseInOut.GHI_DAISYLINK_VERSION_PULSE, PulseInOut.GHI_DAISYLINK_VERSION_PULSE, 50, "PulseInOut") {
			Socket socket = Socket.GetSocket(socketNumber, true, this, null);
			socket.EnsureTypeIsSupported(new char[] { 'X', 'Y' }, this);
		}

		/// <summary>Reads the current PWM wave on the given input.</summary>
		...
		/// <summary>Starts a pulse on the given pwm channel.</summary>
