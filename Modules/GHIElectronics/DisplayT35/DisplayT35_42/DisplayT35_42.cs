...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    ///         GTM.GHIElectronics.DisplayT35 display = new DisplayT35(12, 13, 14);
    ///
    ///         void ProgramStarted()
    ///         {
    ...
    public class DisplayT35 : GTM.Module.DisplayModule
    {
        ...
        // The example also uses the recommended code pattern for exposing two events: DisplayT35High, DisplayT35Low. 
        // The triple-slash "///" comments shown will be used in the build process to create an XML file named
        // GTM.GHIElectronics.DisplayT35. This file will provide Intellisense and documention for the
