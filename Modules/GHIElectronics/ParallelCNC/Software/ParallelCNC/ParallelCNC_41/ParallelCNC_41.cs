...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    /// </summary>
    public class ParallelCNC : GTM.Module.DaisyLinkModule
    {
        ...
        void ParallelCNC_DaisyLinkInterrupt(Module.DaisyLinkModule sender)
        {
            // Interrupt occured, read the registers and determine what even to send.
        }
        ...
        /// <param name="zSteps"></param>
        /// <param name="aSteps"></param>
        /// <param name="bSteps"></param>
