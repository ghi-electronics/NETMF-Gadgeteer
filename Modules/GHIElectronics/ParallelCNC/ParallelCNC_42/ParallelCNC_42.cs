...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    /// <summary>
    /// A CNC interface module using a parallel port for Microsoft .NET Gadgeteer
    /// </summary>
    /// <example>
    /// <para>The following example uses a <see cref="ParallelCNC"/> object to move a set of motors attached to a CNC control board. 
    /// </para>
    /// <code>
    ///using System;
