...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class FLASH : GTM.Module
    {
        ...
        // GTM.GHIElectronics.FLASH. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the FLASH module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public FLASH(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the FLASH is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="FLASH"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="FLASH"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="FLASH"/></param>
        public delegate void ButtonEventHandler(FLASH sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="FLASH"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="FLASH"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="FLASH"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(FLASH sender, ButtonState buttonState)
        {
