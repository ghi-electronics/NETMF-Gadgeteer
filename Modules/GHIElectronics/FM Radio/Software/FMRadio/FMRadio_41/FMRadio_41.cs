...
namespace Gadgeteer.Modules.GHIElectronics {
	/// <summary>
	/// A FMRadio module for Microsoft .NET Gadgeteer
	/// </summary>
	public class FMRadio : GTM.Module {
		...
		// GTM.GHIElectronics.FMRadio. This file will provide IntelliSense and documentation for the
		// interface and make it easier for developers to use the FMRadio module.        

		// Note: A constructor summary is auto-generated by the doc builder.
		/// <summary></summary>
		/// <param name="socketNumber">The socket that this module is plugged in to.</param>
		/// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
		public FMRadio(int socketNumber, int socketNumberTwo) {
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the FMRadio is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="FMRadio"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="FMRadio"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="FMRadio"/></param>
		public delegate void ButtonEventHandler(FMRadio sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="FMRadio"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="FMRadio"/> is released.
		/// </summary>
		/// <remarks>
		...
		protected virtual void OnButtonEvent(FMRadio sender, ButtonState buttonState) {
