...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class Keypad_KP16 : GTM.Module
	{
		...
		public Keypad_KP16(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the Keypad_KP16 is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="Keypad_KP16"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="Keypad_KP16"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="Keypad_KP16"/></param>
		public delegate void ButtonEventHandler(Keypad_KP16 sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="Keypad_KP16"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="Keypad_KP16"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="Keypad_KP16"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(Keypad_KP16 sender, ButtonState buttonState)
		{
