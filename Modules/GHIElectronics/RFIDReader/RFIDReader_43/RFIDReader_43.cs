...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    /// <summary>
    /// A 125Khz RFIDReader reader module for Microsoft .NET Gadgeteer
    /// </summary>
    /// <example>
    /// <para>The following example uses a <see cref="RFIDReader"/> object to display the ID of a swiped RFIDReader card.</para>
    /// <code>
    /// using System;
    ...
    ///         void ProgramStarted()
    ///         {
    ///             rfid.CardIDReceived += new RFIDReader.CardIDReceivedEventHandler(rfid_CardIDReceived);
    ///         }
    ///
    ///         void rfid_CardIDReceived(RFIDReader sender, string ID)
    ///         {
    ///             Debug.Print(ID);
    ///         }
    ///     }
    ...
    public class RFIDReader : GTM.Module
    {
        ...
        public delegate void CardIDReceivedEventHandler(RFIDReader sender, String ID);
        ...
        /// <param name="ID">ID that was read.</param>
        protected virtual void OnIDReadyEvent(RFIDReader sender, String ID)
        {
        ...
        public delegate void CardIDBadChecksumEventHandler(RFIDReader sender, String ID);
