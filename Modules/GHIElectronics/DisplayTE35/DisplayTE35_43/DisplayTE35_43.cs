...
namespace Gadgeteer.Modules.GHIElectronics {
	...
	public class DisplayTE35 : GTM.Module.DisplayModule {
		...
		public DisplayTE35(int rSocketNumber, int gSocketNumber, int bSocketNumber)
		...
		public DisplayTE35(int rSocketNumber, int gSocketNumber, int bSocketNumber, int tSocketNumber)
