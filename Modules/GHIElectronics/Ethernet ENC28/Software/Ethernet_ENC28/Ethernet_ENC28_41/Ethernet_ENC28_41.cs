...
{
    /// <summary>
    /// A Ethernet_ENC28 module for Microsoft .NET Gadgeteer
    /// </summary>
    public class Ethernet_ENC28 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Ethernet_ENC28. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Ethernet_ENC28 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Ethernet_ENC28(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Ethernet_ENC28 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Ethernet_ENC28"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Ethernet_ENC28"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Ethernet_ENC28"/></param>
        public delegate void ButtonEventHandler(Ethernet_ENC28 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Ethernet_ENC28"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Ethernet_ENC28"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Ethernet_ENC28"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Ethernet_ENC28 sender, ButtonState buttonState)
        {
