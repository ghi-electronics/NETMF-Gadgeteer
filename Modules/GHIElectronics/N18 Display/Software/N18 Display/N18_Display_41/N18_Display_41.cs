...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class N18_Display : GTM.Module
    {
        ...
        // GTM.GHIElectronics.N18_Display. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the N18 Display module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public N18_Display(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the N18_Display is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="N18_Display"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="N18_Display"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="N18_Display"/></param>
        public delegate void ButtonEventHandler(N18_Display sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="N18_Display"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="N18_Display"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="N18_Display"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(N18_Display sender, ButtonState buttonState)
        {
