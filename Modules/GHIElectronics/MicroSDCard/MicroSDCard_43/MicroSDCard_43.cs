...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class MicroSDCard : GTM.Module
    {
        ...
        // GTM.GHIElectronics.MicroSDCard. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the MicroSDCard module.        
        ...
        public MicroSDCard(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the MicroSDCard is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="MicroSDCard"/>.
        /// </summary>
        ...
        /// <param name="state">The state of the button of the <see cref="MicroSDCard"/></param>
        public delegate void ButtonEventHandler(MicroSDCard sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="MicroSDCard"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="MicroSDCard"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="MicroSDCard"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(MicroSDCard sender, ButtonState buttonState)
        {
