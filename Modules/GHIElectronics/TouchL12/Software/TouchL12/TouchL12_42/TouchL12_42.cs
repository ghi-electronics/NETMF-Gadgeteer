...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class TouchL12 : GT.Modules.Module
	{
		...
		public TouchL12(int socketNumber)
		{
			...
			this.device = new GTI.I2CBus(this.socket, TouchL12.I2C_ADDRESS, TouchL12.I2C_CLOCK_RATE, this);
		...
		private void WriteSPM(byte address, byte[] values)
		{
			...
			this.device.Write(values, 100); //needs to begin with a 0 representing the I2C address of 0.
