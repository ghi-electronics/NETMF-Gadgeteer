...
{
    /// <summary>
    /// A MulticolorLED module for Microsoft .NET Gadgeteer
    /// </summary>
    public class MulticolorLED : GTM.DaisyLinkModule
    {
        ...
        public MulticolorLED(int socketNumber) : base(socketNumber, MulticolorLED.GHI_DAISYLINK_MANUFACTURER, MulticolorLED.GHI_DAISYLINK_TYPE, MulticolorLED.GHI_DAISYLINK_VERSION, MulticolorLED.GHI_DAISYLINK_VERSION, 50, "MulticolorLED")
        {
        ...
        /// <summary>
        /// Whether or not the green and blue channels should be swapped.
        /// </summary>
        public bool GreenBlueSwapped { get; set; }

        /// <summary>
        /// Returns an array of MulticolorLEDs for each hardware module that is physically connected to the specified socket.
        /// </summary>
        ...
        /// <summary>
        ///  Causes the LED to light in the specified color for the specified duration, switch to the second color for another specified duration, and repeat.
        /// </summary>
        ...
        /// <summary>
        /// The delegate that is used to handle the animation finished event.
        /// </summary>
        ...
        /// <summary>
        /// Raised when the BlinkOnce or FadeOnce animation has finished.
        /// </summary>
