...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    /// </summary>
    /// <example>
    /// <para>The following example uses a <see cref="SerialCameraL2"/> object to capture a picture when a button is pressed and display it on a display.</para>
    /// <code>
    /// using System;
    ...
    ///         void ProgramStarted()
    ///         {
    ///             sercam.SetImageSize(SerialCameraL2.Camera_Resolution.SIZE_QVGA);
    ///             sercam.PictureCaptured += new SerialCameraL2.PictureCapturedEventHandler(sercam_PictureCaptured);
    ///
    ...
    ///         }
    ///
    ///         void sercam_PictureCaptured(GTM.GHIElectronics.SerialCameraL2 sender, Bitmap picture)
    ///         {
    ///             Debug.GC(true);
    ...
    public class SerialCameraL2 : GTM.Module
    {
        ...
        public SerialCameraL2(int socketNumber)
        {
            ...
            serialPort = GTI.SerialFactory.Create(socket, 115200, GTI.SerialParity.None, GTI.SerialStopBits.One, 8, GTI.HardwareFlowControl.NotRequired, this);
            ...
            while (isUpdateStreaming)            
            {
                try
                {
                    ...
                    if (dataSize > 0)
                    {
                        ...
                        {
                            ResetCamera(); // Reset SerialCameraL2
                        }
                        else
                        {
