...
{
    /// <summary>
    /// A EVE800 module for Microsoft .NET Gadgeteer
    /// </summary>
    public class EVE800 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.EVE800. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the EVE800 module.        
        ...
        public EVE800(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the EVE800 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="EVE800"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="EVE800"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="EVE800"/></param>
        public delegate void ButtonEventHandler(EVE800 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="EVE800"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="EVE800"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="EVE800"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(EVE800 sender, ButtonState buttonState)
        {
