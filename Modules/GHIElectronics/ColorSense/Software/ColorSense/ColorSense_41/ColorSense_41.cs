...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class ColorSense : GTM.Module
    {
        ...
        // GTM.GHIElectronics.ColorSense. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the ColorSense module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public ColorSense(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the ColorSense is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="ColorSense"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="ColorSense"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="ColorSense"/></param>
        public delegate void ButtonEventHandler(ColorSense sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="ColorSense"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="ColorSense"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="ColorSense"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(ColorSense sender, ButtonState buttonState)
        {
