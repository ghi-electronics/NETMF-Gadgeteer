...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class Accel_G248 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Accel_G248. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Accel G248 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Accel_G248(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Accel_G248 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Accel_G248"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Accel_G248"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Accel_G248"/></param>
        public delegate void ButtonEventHandler(Accel_G248 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Accel_G248"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Accel_G248"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Accel_G248"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Accel_G248 sender, ButtonState buttonState)
        {
