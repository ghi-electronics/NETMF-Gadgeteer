...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class WiFi_RN171 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.WiFi_RN171. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the WiFi RN171 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public WiFi_RN171(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the WiFi_RN171 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="WiFi_RN171"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="WiFi_RN171"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="WiFi_RN171"/></param>
        public delegate void ButtonEventHandler(WiFi_RN171 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="WiFi_RN171"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="WiFi_RN171"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="WiFi_RN171"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(WiFi_RN171 sender, ButtonState buttonState)
        {
