...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class DAQ_8B : GTM.Module
	{
		...
		public DAQ_8B(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the DAQ_8B is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="DAQ_8B"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="DAQ_8B"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="DAQ_8B"/></param>
		public delegate void ButtonEventHandler(DAQ_8B sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="DAQ_8B"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="DAQ_8B"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="DAQ_8B"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(DAQ_8B sender, ButtonState buttonState)
		{
