...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class Distance_US3 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Distance_US3. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Distance US3 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Distance_US3(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Distance_US3 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Distance_US3"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Distance_US3"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Distance_US3"/></param>
        public delegate void ButtonEventHandler(Distance_US3 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Distance_US3"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Distance_US3"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Distance_US3"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Distance_US3 sender, ButtonState buttonState)
        {
