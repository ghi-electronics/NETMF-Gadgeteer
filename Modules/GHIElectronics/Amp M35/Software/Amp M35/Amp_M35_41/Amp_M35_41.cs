...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class Amp_M35 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.Amp_M35. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the Amp M35 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public Amp_M35(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the Amp_M35 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="Amp_M35"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Amp_M35"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="Amp_M35"/></param>
        public delegate void ButtonEventHandler(Amp_M35 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="Amp_M35"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="Amp_M35"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="Amp_M35"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(Amp_M35 sender, ButtonState buttonState)
        {
