...
namespace Gadgeteer.Modules.GHIElectronics {
	/// <summary>A RelayISOx16 for Microsoft .NET Gadgeteer</summary>
	[Obsolete]
	public class RelayISOx16 : GTM.Module {
		...
		/// <summary>The relays on the module.</summary>
		[Flags]
		public enum Relays : ushort {

			/// <summary>Relay 1</summary>
			Relay1 = 1,

			/// <summary>Relay 2</summary>
			Relay2 = 2,

			/// <summary>Relay 3</summary>
			Relay3 = 4,

			/// <summary>Relay 4</summary>
			Relay4 = 8,

			/// <summary>Relay 5</summary>
			Relay5 = 16,

			/// <summary>Relay 6</summary>
			Relay6 = 32,

			/// <summary>Relay 7</summary>
			Relay7 = 64,

			/// <summary>Relay 8</summary>
			Relay8 = 128,

			/// <summary>Relay 9</summary>
			Relay9 = 256,

			/// <summary>Relay 10</summary>
			Relay10 = 512,

			/// <summary>Relay 11</summary>
			Relay11 = 1024,

			/// <summary>Relay 12</summary>
			Relay12 = 2048,

			/// <summary>Relay 13</summary>
			Relay13 = 4096,

			/// <summary>Relay 14</summary>
			Relay14 = 8192,

			/// <summary>Relay 15</summary>
			Relay15 = 16384,

			/// <summary>Relay 16</summary>
			Relay16 = 32768,
		}
		...
		/// <summary>Enables the given relays.</summary>
		...
		/// <summary>Disables the given relays.</summary>
		...
		/// <summary>Enables the relay outputs.</summary>
		private void EnableOutputs() {
			this.enable.Write(false);
		}

		/// <summary>Disables the relay outputs.</summary>
