...
{
    /// <summary>
    /// A RelayISOx16 module for Microsoft .NET Gadgeteer
    /// </summary>
    public class RelayISOx16 : GTM.Module
    {
        ...
        // GTM.GHIElectronics.RelayISOx16. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the RelayISOx16 module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public RelayISOx16(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the RelayISOx16 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="RelayISOx16"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="RelayISOx16"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="RelayISOx16"/></param>
        public delegate void ButtonEventHandler(RelayISOx16 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="RelayISOx16"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="RelayISOx16"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="RelayISOx16"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(RelayISOx16 sender, ButtonState buttonState)
        {
