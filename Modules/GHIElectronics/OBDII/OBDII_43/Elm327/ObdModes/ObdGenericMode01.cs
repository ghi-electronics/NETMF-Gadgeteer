...
namespace Elm327.Core.ObdModes {
	...
	public class ObdGenericMode01 : AbstractObdMode {
		...
		/// <summary>Creates an instance of <see cref="ObdGenericMode01" />.</summary>
		...
		public double EngineRpm {
			get {
				// This value is returned in two bytes. Divide the reading by 4 to get the correct RPM value.
		...
		public double EstimatedDistancePerGallon {
			get {
				...
				// TODO: This value is instantaneous. Either we or the caller need to average the values over a period of time to smooth out the reading.
		...
		public double MassAirFlowRate {
			get {
				// This value is returned in two bytes. Divide the reading by 100 to get the correct MAF value.
