...
namespace Gadgeteer.Modules.GHIElectronics
{
	...
	public class HubAP5 : GTM.Module
	{
		...
		// GTM.GHIElectronics.HubAP5. This file will provide IntelliSense and documentation for the
		// interface and make it easier for developers to use the HubAP5 module.        

		// Note: A constructor summary is auto-generated by the doc builder.
		/// <summary></summary>
		/// <param name="socketNumber">The socket that this module is plugged in to.</param>
		/// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
		public HubAP5(int socketNumber, int socketNumberTwo)
		{
		...
		/// <summary>
		/// Gets a value that indicates whether the button of the HubAP5 is pressed.
		/// </summary>
		...
		/// <summary>
		/// Represents the state of button of the <see cref="HubAP5"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="sender">The <see cref="HubAP5"/> object that raised the event.</param>
		/// <param name="state">The state of the button of the <see cref="HubAP5"/></param>
		public delegate void ButtonEventHandler(HubAP5 sender, ButtonState state);

		/// <summary>
		/// Raised when the button of the <see cref="HubAP5"/> is pressed.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Raised when the button of the <see cref="HubAP5"/> is released.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="sender">The <see cref="HubAP5"/> that raised the event.</param>
		/// <param name="buttonState">The state of the button.</param>
		protected virtual void OnButtonEvent(HubAP5 sender, ButtonState buttonState)
		{
